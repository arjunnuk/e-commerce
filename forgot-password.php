...
?>
		...
		<div class="form-group">
		 ...
		 <input type="text" name="contact"  ondrop="return false;" onpaste="return false;" onkeypress='return event.charCode>=48&&event.charCode<=57' class="form-control unicase-form-control text-input" id="contact" maxlength="10" minlength="10" required>
		</div>
<div class="form-group">
